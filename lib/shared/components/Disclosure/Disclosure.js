...
export const Disclosure = ({ items }) => {
    ...
    return (_jsx("div", { className: style, children: items.map(({ title, text }, key) => {
            return (_jsx(DisclosureComponent, { children: ({ open }) => (_jsx(_Fragment, { children: _jsxs(DisclosureComponent.Button, { className: "w-full py-[15px] px-[30px] text-h4-semi-bold text-neutral-800 border rounded-[4px] border-neutral-150", children: [_jsxs("div", { className: "flex justify-between", children: [_jsx("div", { children: title }), _jsx("div", { className: `${!!open && 'rotate-180'}`, children: _jsx(Icon, { name: "shootingArrowRight", size: "xlarge" }) })] }), _jsx("div", { children: _jsx(DisclosureComponent.Panel, { className: "pt-4 pb-2 text-left text-p1-medium text-neutral-500", children: text }) })] }) })) }, key));
        }) }));
};
