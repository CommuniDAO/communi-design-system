...
export var DefaultInput = function DefaultInput(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    className: "shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-neutral-200 rounded-md text-neutral-800 bg-neutral-100 ".concat(disabled && 'text-neutral-300 cursor-not-allowed'),
