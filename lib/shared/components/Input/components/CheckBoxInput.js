...
export var CheckBoxInput = function CheckBoxInput(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    className: "mt-1 flex flex-wrap w-full border border-neutral-100 space-x-2 text-center p-1.5 rounded-md bg-neutral-100 text-xs"
  }, list.map(function (item, key) {
    return /*#__PURE__*/React.createElement("div", {
      key: key,
      className: "flex-1 p-1 rounded-md cursor-pointer ".concat(item.active ? 'bg-secondary-400 text-secondary-100 font-bold' : 'bg-neutral-100 text-neutral-800'),
