...
export const DynamicForm = {
    render: (args) => {
        ...
        const updateGrandchild = async (e) => {
            if (e.value === '1') {
                return [
                    { name: 'Option A 1', value: 5 },
                    { name: 'Option A 2', value: 6 }
                ];
            }
            else if (e.value === '2') {
                return [
                    { name: 'Option B 1', value: 7 },
                    { name: 'Option B 2', value: 8 }
                ];
            }
            else if (e.value === '3') {
                return [
                    { name: 'Option C 1', value: 9 },
                    { name: 'Option C 2', value: 10 }
                ];
            }
            else if (e.value === '4') {
                return [
                    { name: 'Option D 1', value: 11 },
                    { name: 'Option D 2', value: 12 }
                ];
            }
        };
        const fields = [
        ...
        return _jsx(Form, { ...args, fields: fields });
    },
    parameters: {
        design: {
            type: 'figma',
