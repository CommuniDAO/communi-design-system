...
import { RadioGroup } from '~/src/shared/components/RadioGroup';
...
export const Default = () => _jsx(RadioGroup, { options: options, variant: "horizontal" });
Default.parameters = {
    design: {
        type: 'figma',
...
export const Vertical = () => _jsx(RadioGroup, { options: verticalOptions, variant: "vertical" });
Vertical.parameters = {
    design: {
        type: 'figma',
        url: 'https://www.figma.com/file/vkIFRuwbONhF3qrGI7bHvL/App?node-id=2%3A129'
