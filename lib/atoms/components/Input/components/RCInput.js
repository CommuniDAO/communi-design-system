...
export const RCInput = ({ config }) => {
    ...
    return (_jsx(_Fragment, { children: _jsxs("div", { className: "flex", children: [_jsx(CodeInput, { id: id, autoFocus: autoFocus, className: TextStyle, length: maxLength, readOnly: state !== 'input', disabled: state === 'loading', inputRef: inputRef, padding: "8px", spacing: "16px", spellCheck: false, inputMode: 'numeric', pattern: '[0-9]*', autoComplete: 'one-time-code', onChange: ({ currentTarget: input }) => {
                    ...
                    }, renderSegment: ({ state, index }) => (_jsx("div", { className: InputStyle, "data-state": state, style: { width, height: '100%' }, children: _jsx("div", {}) }, index)) }), _jsxs("div", { className: iconStyle, children: [state === 'loading' &&
                            _jsx("div", { className: "origin-center animate-spin", children: _jsx(Icon, { name: "spinner", size: "medium" }) }), state === 'success' && _jsx(CheckIcon, { className: "w-[30px] h-[30px]" }), state === 'error' && _jsx(XIcon, { className: "w-[30px] h-[30px]" })] })] }) }));
};
